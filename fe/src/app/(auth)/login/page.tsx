  ...
  return (
    <>
      ...
      <div className="space-y-4 mb-8">
        <Button onClick={() => toast.info("Redirecting to GitHub...")} variant="outline" className="w-full h-12 bg-card hover:bg-secondary border-border text-foreground">
        <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="currentColor" stroke="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Button onClick={() => toast.info("Redirecting to Google...")} variant="outline" className="w-full h-12 bg-card hover:bg-secondary border-border text-foreground">
