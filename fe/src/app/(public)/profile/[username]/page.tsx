        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <CardContent className="p-6 pt-0 relative">
              ...
              <div className="text-center mb-6">
                <h1 className="text-2xl font-heading font-bold text-foreground flex items-center justify-center gap-2">
                  {PROFILE.fullName}
                  {PROFILE.isVerifiedSeller && <ShieldCheck className="w-5 h-5 text-success" />}
                </h1>
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="pt-4 border-t border-border flex justify-center gap-4">
                  {PROFILE.github && (
                    <a href={`https://github.com/${PROFILE.github}`} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  ...
                  {PROFILE.twitter && (
                    <a href={`https://twitter.com/${PROFILE.twitter}`} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-[#1DA1F2] transition-colors">
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" stroke="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Card className="border-border bg-card">
            <CardContent className="p-6">
              <h3 className="font-heading font-semibold mb-4">Skills</h3>
