...
import com.example.template.dto.request.GoogleLoginRequest;
...
public class ApiAuthController {
    ...
    public ResponseEntity<TokenResponse> login(@Valid @RequestBody LoginRequest request, HttpServletRequest httpServletRequest) {
        log.info("Login request for user: {}", request.getUsername() != null ? request.getUsername() : request.getEmail());
